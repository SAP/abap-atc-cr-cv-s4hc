...
The files objectClassification.json or objectClassification.csv contains the Classic APIs  to be consumed in your Tier 2 implementations of the 3-tier extensibility model.
